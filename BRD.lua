-- BRD TODO List
-- Need to cap skill, and look into getting gears
...
function init_gear_sets()
    ...
    sets.precast.FC = {
        ...
        back="Intarabus's Cape",waist="Witful Belt",legs="Aya. Cosciales +2",feet="Kaykaus Boots"}

    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash"})

    sets.precast.FC.BardSong = {main="Sangoma",sub="Ammurapi Shield",range="Eminent Flute",
        head="Nahtirah Hat",neck="Baetyl Pendant",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
        body="Inyanga Jubbah +2",hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Weather. Ring",
        back="Intarabus's Cape",waist="Witful Belt",legs="Inyanga Shalwar +2",feet="Telchine Pigaches"}
    ...
    sets.midcast.Lullaby = {range=info.ExtraSongInstrument,hands="Brioso Cuffs"}
    ...
    sets.midcast.SongEffect = {main="Legato Dagger",sub="Ammurapi Shield",range="Eminent Flute",
        head="Inyanga Tiara +2",neck="Moonbow Whistle",ear1="Digni. Earring",ear2="Regal Earring",
        body="Inyanga Jubbah +2",hands="Inyan. Dastanas +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
        back="Intarabus's Cape",waist="Witful Belt",legs="Inyanga Shalwar +2",feet="Inyan. Crackows +2"}
    sets.midcast["Honor March"] = set_combine(sets.midcast.SongEffect,{range="Marsyas"})

    -- For song defbuffs (duration primary, accuracy secondary)
    sets.midcast.SongDebuff = {main="Sangoma",sub="Ammurapi Shield",range="Eminent Flute",
        head="Inyanga Tiara +2",neck="Moonbow Whistle",ear1="Digni. Earring",ear2="Regal Earring",
        body="Inyanga Jubbah +2",hands="Inyan. Dastanas +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
        back="Intarabus's Cape",waist="Witful Belt",legs="Inyanga Shalwar +2",feet="Inyan. Crackows +2"}

    -- For song defbuffs (accuracy primary, duration secondary)
    sets.midcast.ResistantSongDebuff = {main="Sangoma",sub="Ammurapi Shield",range="Eminent Flute",
        head="Inyanga Tiara +2",neck="Moonbow Whistle",ear1="Digni. Earring",ear2="Gwati Earring",
        body="Inyanga Jubbah +2",hands=ChironicMAccHands,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
        back="Intarabus's Cape",waist="Witful Belt",legs="Inyanga Shalwar +2",feet="Inyan. Crackows +2"}

    -- Song-specific recast reduction
    sets.midcast.SongRecast = {main="Sangoma",sub="Ammurapi Shield",range="Eminent Flute",
        head="Nahtirah Hat",neck="Baetyl Pendant",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
        body="Inyanga Jubbah +2",hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Weather. Ring",
        back="Intarabus's Cape",waist="Witful Belt",legs="Inyanga Shalwar +2",feet="Telchine Pigaches"}
    ...
    sets.midcast.DaurdablaDummy = {main="Sangoma",sub="Ammurapi Shield",range=info.ExtraSongInstrument,
        head="Nahtirah Hat",neck="Baetyl Pendant",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
        body="Inyanga Jubbah +2",hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Weather. Ring",
    ...
    sets.idle = {main="Sangoma",sub="Ammurapi Shield",range="Eminent Flute",
    ...
    sets.idle.Weak = {main="Sangoma",sub="Ammurapi Shield",range="Eminent Flute",
      head="Inyanga Tiara +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Static Earring",
      body="Inyanga Jubbah +2",hands="Inyan. Dastanas +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
      back="Solemnity Cape",waist="Fucho-no-obi",legs="Inyanga Shalwar +2",feet="Inyan. Crackows +2"}
