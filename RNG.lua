...
function user_setup()
	...
	DefaultAmmo = {['Yoichinoyumi'] = "Achiyalabopa arrow", ['Annihilator'] = "Eminent bullet"}
	U_Shot_Ammo = {['Yoichinoyumi'] = "Achiyalabopa arrow", ['Annihilator'] = "Eminent bullet"}
	...
	LeftDarkRing = {name="Dark Ring",augments={"Phys. dmg. taken -4%", "Magic dmg. taken -5%"}}
	RightDarkRing = {name="Dark Ring",augments={"Phys. dmg. taken -4%", "Magic dmg. taken -4%"}}	
end
...
function init_gear_sets()
	...
	sets.precast.WS = {
		head="Orion Beret +1",neck=gear.ElementalGorget,ear1="Clearview Earring",ear2="Volley Earring",
		body="Orion Jerkin +1",hands="Buremte Gloves",ring1="Pyrosoul Ring",ring2="Rajas Ring",
		back="Terebellum Mantle",waist=gear.ElementalBelt,legs="Nahtirah Trousers",feet="Orion Socks +1" }

	--sets.precast.WS.Acc = set_combine(sets.precast.WS, {body="Kyujutsugi",ring1="Hajduk Ring",ring2="Rajas Ring",
	--	back="Lutian Cape",legs="Orion Braccae +1"})
	sets.precast.WS.Acc = set_combine(sets.precast.WS, {ring1="Hajduk Ring",legs="Orion Braccae +1"})
	...
	sets.midcast.RA = {
		...
		body="Orion Jerkin +1",hands="Buremte Gloves",ring1="Hajduk Ring",ring2="Hajduk Ring",
		back="Libeccio Mantle",waist="Scout's Belt",legs="Nahtirah Trousers",feet="Orion Socks +1"}
	...
	sets.idle = {
		...
		back="Shadow Mantle",waist="Scout's Belt",legs="Blood Cuisses",feet="Orion Socks +1"}
	...
	sets.engaged = {
		head="Orion Beret +1",neck="Twilight Torque",ear1="Steelflash Earring",ear2="Bladeborn Earring",
		body="Orion Jerkin +1", hands="Buremte Gloves", ring1="Pyrosoul Ring",ring2="Tyrant's Ring",
